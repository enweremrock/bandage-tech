        ...
        >
          <Box
            sx={{
              ...
              gap: "1.5rem",
              position: "relative",
              backgroundImage: "url(/asset/images/1.png)",
          ...
          >
            <Box
              sx={{
                ...
                flexShrink: 0,
                position: "relative",
                backgroundImage: "url(/asset/images/2.png)",
                backgroundRepeat: "no-repeat",
                objectFit: "cover",
                backgroundSize: "cover",
              }}
            ...
            >
              <Box
                sx={{
                  ...
                  position: "relative",
                  backgroundImage: "url(/asset/images/3.png)",
                  backgroundRepeat: "no-repeat",
                  objectFit: "cover",
                  backgroundSize: "cover",
                }}
              ...
              <Box
                sx={{
                  ...
                  position: "relative",
                  backgroundImage: "url(/asset/images/4.png)",
                  backgroundRepeat: "no-repeat",
                  objectFit: "cover",
                  backgroundSize: "cover",
                }}
